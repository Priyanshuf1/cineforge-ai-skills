...
const pages = [
  { file: 'index.md', title: 'Getting Started', content: '# Getting Started\n\nWelcome to the CineForge AI Skills documentation. This experimental toolkit provides creative-web skills for autonomous agents.\n' },
  { file: 'installation.md', title: 'Installation', content: '# Installation\n\nFollow the instructions on the [GitHub repository](https://github.com/Priyanshuf1/cineforge-ai-skills) for stable releases.\n' },
  { file: 'cli.md', title: 'CLI Reference', content: '# CLI Reference\n\nLearn how to use `cineforge install`, `update`, `backup`, and `restore`.\n' },
